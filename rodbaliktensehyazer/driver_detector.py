...
cham = mixer.Sound('alarm/att.wav')
clm = mixer.Sound('alarm/pause.wav')
...
while True:
    ...
    for rect in rects:
        ...
        cv2.putText(frame, 'Time:' + str(COUNTER), (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        
        if COUNTER > 35:
            cham.play()

        elif mouEAR > MOU_AR_THRESH:
            yawns += 1
        ...
        cv2.putText(frame, "Group1IA", (370, 470), cv2.FONT_HERSHEY_COMPLEX, 0.6, (153, 51, 102), 1)
